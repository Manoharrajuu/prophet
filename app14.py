...
try:
    ...
    st.error("❌ The 'matplotlib' library is not installed. Please install it using `pip install matplotlib`.")
    st.stop()
...
try:
    ...
    st.error("❌ The 'joblib' library is not installed. Please install it using `pip install joblib`.")
    st.stop()
...
try:
    ...
    st.error("❌ The 'prophet' library is not installed. Please install it using `pip install prophet`.")
    st.stop()
